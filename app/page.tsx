    ...
    <main className="flex h-screen flex-col items-center justify-center lg:p-40 p-10 w-full">
      <div className="flex justify-center flex-col items-center absolute z-10 my-auto p-40 top-0 h-screen">
        ...
        <p className="text-lg text-center">
          ...
          <Link href="https://twitter.com/thefalsedotnet" className={cn(buttonVariants({ variant: "link" }), "text-lg p-0")}>
            x (twitter)
          </Link>
          {" "}
          <Link href="https://instagram.com/thefalsedotnet" className={cn(buttonVariants({ variant: "link" }), "text-lg p-0")}>
            instagram
          </Link>
        </p>
      </div>
