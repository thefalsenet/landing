...
export function SiteHeader() {
  ...
  return (
    <div
      className={`flex-none left-1/2 fixed top-0 -translate-x-1/2 w-full flex items-center content-center z-50 h-16 transition-colors duration-200 ${scrolled ? "bg-background border-b" : ""}`}
    >
